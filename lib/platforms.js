...
module.exports = {
    win32: {
        ...
        files: { // First file must be the executable
            ...
            '>=0.12.0 <=0.12.3': ['nw.exe', 'ffmpegsumo.dll', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw.pak', 'locales', 'd3dcompiler_47.dll', 'pdf.dll'],
            '>=0.13.0': ['nw.exe','ffmpeg.dll','icudtl.dat','libEGL.dll','libGLESv2.dll','locales','natives_blob.bin','node.dll','nw_100_percent.pak','nw_200_percent.pak','nw_elf.dll','nw_material_100_percent.pak','nw_material_200_percent.pak','nw.dll','resources.pak','snapshot_blob.bin','d3dcompiler_47.dll']
        },
